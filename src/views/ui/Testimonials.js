...
const Testimonials = () => {
  ...
  const handleEditTestimonial = () => {
    ...
    fetch(
      `https://tastykitchen-backend.vercel.app/testimonials/${currentTestimonial._id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  const handleDeleteTestimonial = (id) => {
    fetch(`https://tastykitchen-backend.vercel.app/testimonials/${id}`, {
      method: "DELETE",
    })
      .then((response) => response.json())
      .then(() => {
                    ...
                    <CardBody>
                      <div className="flex items-center space-x-3 mb-2">
                        <div className="border rounded-full w-8 h-8 flex items-center justify-center">
                          <p className="text-xs font-semibold text-main tracking-wider">
                            {" "}
                            {testimonial.author
                              .split(" ")
